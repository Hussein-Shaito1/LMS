  ...
  return (
    <div className="course-card">
      <div className="course-card__thumbnail">
        ...
        />
        <span
          className={`badge badge--${getLevelClass(course.level)} course-card__thumbnail-badge`}
        >
          {course.level}
        </span>
        <button
      ...
      <div className="course-card__body">
        ...
        <h3 className="course-card__title">
          <Link
            ...
            className="course-card__main-link"
          >
            {course.title}
          </Link>
        </h3>
        ...
        {showProgress && <ProgressBar percent={progressPct} label="Progress" />}
